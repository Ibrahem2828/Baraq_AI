...
MOCK_SUCCESS_PAYLOADS: dict[str, dict[str, Any]] = {
    ...
    "kholasa_generate_summary": {
        ...
        "executive_summary": (
            "نقطة تجريبية أولى ونقطة تجريبية ثانية ضمن ملخص تنفيذي مصطنع."
        ),
        "detailed_summary": (
            "يشرح المصدر نقطة تجريبية أولى ونقطة تجريبية ثانية بإيجاز ضمن "
            "ملخص تنفيذي مصطنع."
        ),
        ...
        "flashcards": [
            {
                "front": "نقطة تجريبية أولى",
                "back": "نقطة تجريبية ثانية",
                "source_references": [1],
            }
        ],
        "limitations": [],
